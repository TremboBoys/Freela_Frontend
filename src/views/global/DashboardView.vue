<script setup>
import { LogoName, InfoProfile, PublicProfile, MainSkills, FavoriteArea, ReviewsProfile, AboutMe, ShortcutsProfile, ProjectProgress, CompletedProject } from '@/components';
